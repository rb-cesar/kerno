...
// módulo redefinir o mesmo formato). Pacote puro: sem Next, Prisma ou React.
 ...
 * no core (não em @kerno/kanban) porque `core/workspaces` também a usa ao criar
 * o board padrão do workspace, e core não pode depender de um módulo.
 */
