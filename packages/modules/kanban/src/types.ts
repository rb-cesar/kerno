...
export type { MemberDTO, StatusCategory } from "@kerno/core/types";
export { DEFAULT_BOARD_COLUMNS } from "@kerno/core/types";

import type { MemberDTO, StatusCategory } from "@kerno/core/types";
...
// por zod na fronteira HTTP (zValidator no controller) — ver ./kanban.dto,
